...
export function gerarComunicadoFalta({ divergencia: d, itens }: Props) {
...
<head>
  <meta charset="UTF-8">
  <title>Comunicado de Falta</title>
  <style>
...
<body>
  ...
  <h1>Comunicado de Falta</h1>
  <div class="loja">LOJA ${d.loja}</div>

  <p>Prezados,</p>
  <p>Informamos que, durante a conferência física do recebimento das notas fiscais listadas abaixo, identificamos uma divergência por falta de mercadoria.</p>

  <p class="section-title">Itens Faltantes (Não entregues)</p>
  <table>
  ...
  <ul>
    <li><strong>Emissão de Nota Fiscal de Devolução Simbólica:</strong> Referente aos itens não recebidos.</li>
    <li><strong>Solicitação de Crédito:</strong> Solicitamos que o valor seja abatido no título financeiro.</li>
  </ul>
